...
web3Override = (web3) => {
  ...
  signTransaction = async (txParams, publicKey) => {
    if (!txParams.chainId) {
    ...
    const data = await keychain.signHex(rawHex, publicKey);
...
module.exports = { web3Override, selectKey };
